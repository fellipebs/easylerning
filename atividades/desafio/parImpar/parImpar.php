...
$_SESSION['pasta'] = "parImpar/parImpar.php";
...
$_SESSION['respostas'] = 
['Parabéns Desfio Feito corretamente, Você Ganhou uma medalha de Ouro'];
...
<body>
  <?php
  require_once("../../../components/menu-atividade.php"); ?>
  <div id="blocklyArea" class="area-bloco"></div>
