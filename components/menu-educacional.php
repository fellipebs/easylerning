    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="../educacional/index.php"><img class="main-logo" src="../assets/img/logo/logo.png" alt="" /></a>
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <!-- <a class="has-arrow" href="../all-courses.html" aria-expanded="false"><span class="educate-icon educate-department icon-wrap"></span> <span class="mini-click-non">Medalhas</span></a> -->
                              <BR><a title="" href="relatorios.php" aria-expanded="false"><img src='../assets/images/grafico.jpg' style='height:35px;'></span> <span class="mini-click-non">Gráficos</span></a>
                        </li>
                        <li>
                        <a title="" href="listagens.php" aria-expanded="false"><img src='../assets/images/listagens.png' style='height:25px;'></span> <span class="mini-click-non">&ensp;Listagens</span></a>
                        </li>
                        <li>
                        <a title="" href="cadastroAluno.php" aria-expanded="false"><img src='../assets/images/default.png' style='height:25px;' ></span><span class="mini-click-non">&ensp;Cadastro de Aluno</span></a>
                        </li>
                        <li>
                        <a title="" href="cadastroProfessor.php" aria-expanded="false"><img src='../assets/images/professoricon.png' style='height:25px;'></span> <span class="mini-click-non">Cadastro de Professor</span></a>
                        </li>
                        <li>
                        <a title="" href="cadastroTurma.php" aria-expanded="false"><img src='../assets/images/turmaicon.png'  style='height:25px;'></span> <span class="mini-click-non">&ensp;Cadastro de Turma</span></a>
                        </li>
                        <li>
                         <a title="" href="cadastrarAula.php" aria-expanded="false"><img src='../assets/images/aulaicones.png'  style='height:25px;'></span> <span class="mini-click-non">&ensp;Cadastro de Aula</span></a>
                        </li>
 			<li>
                         <a title="" href="relatorio.php" aria-expanded="false"><img src='../assets/images/relatorio.png'  style='height:25px;'></span> <span class="mini-click-non">&ensp;Relatório</span></a>
                        </li>
                        <!-- <li>
                        ...
                        <li>
                            <a class="" href="../models/logout.php" aria-expanded="false"><img src='../assets/images/sair.png' style='height:30px;'></span> <span class="mini-click-non">&ensp;Sair</span></a>
                        </li>
                   </ul>
                </nav>
            </div>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                            <?php echo "<img src='../assets/img/profile/".$_SESSION['usuario']->foto."' alt='' />"; ?>
...
<div class="modal fade" id="ModalNotification" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <?php                                
        $sql = $con->prepare("SELECT a.id, a.descricao, a.aluno_id, u.foto, DATE_FORMAT(a.data,'%d/%m') as data, u.usuario, a.id_enviou from notificacao a 
        inner join usuarios u on a.aluno_id = u.id
        where aluno_id = ".$_SESSION['usuario']->id."");
        $sql->execute();
        ...
        if(empty($notificacoes)){
            ...
            foreach($notificacoes as $notificacao){
                ...
                $sql = $con->prepare("SELECT a.id, u.foto from notificacao a inner join usuarios u on a.id_enviou = u.id where a.id = $notificacao->id");
                $sql->execute();
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class='row'>
        <form action='' method='post'><div class='col-sm-4'><input type='image' class='img-circle' src='../assets/img/profile/1.png' style='width: 150px; height: 150px;'><input type='hidden' value='1.png' name='fotos'></div></form>
        <form action='' method='post'><div class='col-sm-4'><input type='image' class='img-circle' src='../assets/img/profile/2.png' style='width: 150px; height: 150px;'><input type='hidden' value='2.png' name='fotos'></div></form>
        <form action='' method='post'><div class='col-sm-4'><input type='image' class='img-circle' src='../assets/img/profile/3.png' style='width: 150px; height: 150px;'><input type='hidden' value='3.png' name='fotos'></div></form>
        </div>
        <br>
        <div class='row'>
        <form action='' method='post'><div class='col-sm-4'><input type='image' class='img-circle' src='../assets/img/profile/4.png' style='width: 150px; height: 150px;'><input type='hidden' value='4.png' name='fotos'></div></form>
        <form action='' method='post'><div class='col-sm-4'><input type='image' class='img-circle' src='../assets/img/profile/5.png' style='width: 150px; height: 150px;'><input type='hidden' value='5.png' name='fotos'></div></form>
        <form action='' method='post'><div class='col-sm-4'><input type='image' class='img-circle' src='../assets/img/profile/6.png' style='width: 150px; height: 150px;'><input type='hidden' value='6.png' name='fotos'></div></form>
        </div>
        <br>
        <div class='row'>
        <form action='' method='post'><div class='col-sm-4'><input type='image' class='img-circle' src='../assets/img/profile/7.png' style='width: 150px; height: 150px;'><input type='hidden' value='7.png' name='fotos'></div></form>
        </div>
        </form>
        <br>                                         

        <h2> Ou envie sua propria foto por aqui! </h2>
    ...
    if(isset($_FILES['foto'])){
       ...
       //header ('Content-type: text/html; charset=utf-8');
        require_once ('../models/conexao/conexao.php');
         ...
         $destino = '../assets/img/profile/' . $_FILES['foto']['name'];
         $arquivo_tmp = $_FILES['foto']['tmp_name'];
         move_uploaded_file( $arquivo_tmp, $destino  );

        $_SESSION['usuario']->foto = $_FILES['foto']['name'];
        $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $pdo->prepare('UPDATE usuarios set foto = :foto WHERE id = :id');
        $stmt->execute(array(
