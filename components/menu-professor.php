        ...
        <nav id="sidebar" class="">
            ...
            <a href="../professor/index.php">
              <img class="main-logo" src="../assets/img/logo/logo.png" alt="" />
                <strong><img src="../assets/img/logo/logosn.png" alt="" /></a></strong>
            </div>
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <a title="" href="lancar_atividade.php" aria-expanded="false"><span class="educate-icon educate-data-table icon-wrap"></span> <span class="mini-click-non">Lançar Atividade</span></a>
                        </li>
                        <!-- <li>
                        ...
                        <li>
                            <a title="" href="../professor/notificacao.php" aria-expanded="false"><span class="educate-icon educate-interface icon-wrap"></span> <span class="mini-click-non">Notificações</span></a>
                        </li>
                        <li>
                        <a title="" href="../professor/listagemNotas.php" aria-expanded="false"><span class="educate-icon educate-charts icon-wrap"></span> <span class="mini-click-non">Notas</span></a>
                        </li> 
                        <!-- <li>
